# BTRBK TUI v2.9 - Project Overview
...
- Snapshot riconosciuti con o senza `@` (timestamp btrbk dopo l'ultimo punto); `--config FILE`

### Stato: Tutte le versioni ✅ Produzione v2.9 (2026-09-24)
